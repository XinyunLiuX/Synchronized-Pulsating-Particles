...
rho = 0.6;           % density of particles rho = N/L^2, number of particles per area
L = sqrt(N/rho);     % domain width
l0 = sqrt(1/rho);    % approximate distance between two particles

% Driving and Damping Parameters
beta = 0.1;          % damping coefficient
epsilon = 0;         % forcing strength
omega   = 0;         % forcing frequency
...
save(sprintf('RES/res_N=%d_rho=%.2f_beta=%.1f_epsilon=%.2f_omega=%.2f.mat', N, rho, beta, epsilon, omega), 'T', 'X', 'Y', 'U', 'K', 'E', 'p');
