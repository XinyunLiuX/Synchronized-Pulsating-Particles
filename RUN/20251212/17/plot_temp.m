clc; clear all
load('RES\res_N=20_rho=2.00_beta=1.4_epsilon=0.04_omega=4.60.mat')
...
VideoOn = 1;
if VideoOn
    exportfineName = sprintf('RES\res_N=%d_rho=%.2f_beta=%.2f_epsilon=%.2f_omega=%.2f', p.N, p.rho, p.beta, p.epsilon, p.omega);
